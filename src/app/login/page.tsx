    ...
    <main className="grid min-h-screen grid-cols-1 bg-white lg:grid-cols-[1.05fr_0.95fr]">
      <section className="flex items-center px-6 py-10 sm:px-12">
        <div className="w-full max-w-md">
          <div className="mb-8">
            <div className="text-sm font-bold uppercase tracking-wide text-alc-blue">AGUSAN LENDING CORPORATION</div>
      ...
      <section className="hidden bg-[linear-gradient(135deg,#1e3a8a,#2563eb)] p-12 text-white lg:flex lg:flex-col lg:justify-end">
